                ...
                <div className="bg-white shadow-lg shadow-main flex flex-col w-full h-full rounded-lg p-5">
                    ...
                    <div className="flex h-full">
                        <div className=" w-3/5 rounded-l-lg border">
                            <div
                                className={`relative top-0 bg-[url("https://img.freepik.com/premium-photo/cute-pastel-pupy-dog-pastl-room_902994-1158.jpg?w=1060")] object-contain bg-center h-full blur-sm saturate-50`}
                            ></div>
                            <img src={src} className="relative h-full object-contain z-50 -top-[510px]" />
                        </div>

                        <div className="flex flex-col bg-white border w-2/5 rounded-r-lg gap-4 p-3 h-full ">
                            <div className="flex flex-col gap-3 overflow-auto h-[400px]">
                                <div className="break-all text-xl">Title</div>
                                <div font-thin>฿ 30,000 {productPrice}</div>
